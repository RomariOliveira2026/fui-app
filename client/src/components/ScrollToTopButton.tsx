...
export default function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed z-30 right-4",
        /* Acima de FABs/chats (bottom-4) + safe area iOS/Android */
        "bottom-[calc(5.25rem+env(safe-area-inset-bottom,0px))] sm:bottom-[calc(4.5rem+env(safe-area-inset-bottom,0px))]",
